                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-1">
                                                    <strong>Precio unitario:</strong> ${producto.currency} ${producto.cost.toLocaleString()}
                                                </p>
                                                <p class="mb-0">
                                                    <strong>Subtotal:</strong> ${producto.currency} ${(producto.cost * producto.count).toLocaleString()}
                                                </p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center">
            ...
            ${
                ...
                <div class="card-footer dark-bg">
                    <div class="d-flex justify-content-between align-items-center">
                        <strong>Total:</strong>
                        <strong>
                            ${carrito[0].currency} ${carrito.reduce((sum, p) => sum + p.cost * p.count, 0).toLocaleString()}
                        </strong>
                    </div>
                </div>
            `
